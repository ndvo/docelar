  ...
  test 'controller content' do
    ...
    assert_file 'app/controllers/posts_controller.rb' do |content|
      ...
      assert_instance_method :update, content do |m|
        assert_match %r{format\.html \{ redirect_to post_url\(@post\), notice: I18n.t('messages.saved') \}}, m
  ...
  if Rails::VERSION::MAJOR >= 6
    test 'controller with namespace' do
      ...
      assert_file 'app/controllers/admin/posts_controller.rb' do |content|
        ...
        assert_instance_method :update, content do |m|
          assert_match %r{format\.html \{ redirect_to admin_post_url\(@post\), notice: I18n.t('messages.saved') \}}, m
        end
